                    ...
                    <form action="{{ route('posts.update', $post) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" rows="5"
                                      class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('content', $post->content) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" id="event_time" name="event_time" value="{{ old('event_time', $post->event_time->format('Y-m-d\TH:i')) }}"
                                   class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
