<x-app-layout>
    {{-- Слот для заголовку сторінки, який з'явиться в хедері --}}
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            {{-- Кнопку створення переносимо в хедер для кращого вигляду --}}
            @auth
                        ...
                        @forelse($posts as $post)
                            <a href="#" class="block p-4 border rounded-lg hover:bg-gray-50">
                                ...
                                <small class="text-sm text-gray-600">
                                    <strong>Організатор:</strong> {{ $post->user->name }} | <strong>Категорія:</strong> {{ $post->category->name }}
                                </small>
                            </a>
                        @empty
